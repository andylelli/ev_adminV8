<template>
	<f7-page stacked name="scoreboard">
		<!-- Nav bar-->
		<f7-navbar>
		...
		<!-- Main section-->
		<scoreboard-table :projectid="projectid"></scoreboard-table>
		<scoreboard-actions :projectid="projectid"></scoreboard-actions>
		<scoreboard-fab-scan :projectid="projectid"></scoreboard-fab-scan>
	</f7-page>
</template>
...
import scoreboardActions from "./scoreboardActions.vue";
import scoreboardFabScan from "./scoreboardFabScan.vue";
			...
			this.$watch(
				...
				function (newValue, oldValue) {
					if (this.getScoreboard) {
						...
						localStorage.admin_update_scoreboard_time = unixtime;
					}
				},
				{ deep: true }
			);
