<template>
	<div>
		<f7-list list :id="'map-title-' + this.projectid" class="no-margin-bottom no-margin-top no-hairline">
...
export default {
	name: "directoryentry-settings-map",
	data() {
		return {
